...
export default function RootLayout({
  ...
  <div className="container mx-auto px-4">
    <div className="flex flex-col md:flex-row justify-between items-center md:items-start">
      {/* Left section: Copyright, location, and company socials */}
      <div className="mb-8 md:mb-0 text-center md:text-left">
        ...
        <div className="mt-6">
          <p className="text-amber-100 font-medium mb-3">Follow us</p>
          <div className="flex justify-center md:justify-start space-x-4">
            {/* Facebook */}
            <a
              href="https://www.facebook.com/share/1DXBBB97c6/?mibextid=wwXIfr"  // Replace with actual company URL
              target="_blank"
            ...
            {/* Telegram */}
            <a
              href="https://t.me/@M_achatoo"  // Replace with actual company username (without @)
              target="_blank"
              rel="noopener noreferrer"
              className="text-white hover:text-amber-300 transition-colors duration-300"
              aria-label="Telegram"
            ...
            {/* Instagram */}
            <a
              href="https://www.instagram.com/emu.furniture?igsh=NXYxd2NmN3pra3M%3D&utm_source=qr"  // Replace with actual company URL
              target="_blank"
              rel="noopener noreferrer"
              className="text-white hover:text-amber-300 transition-colors duration-300"
            ...
            {/* TikTok */}
            <a
              href="https://www.tiktok.com/@emufurniture0?_r=1&_t=ZS-94PA7v0WXC6"  // Replace with actual company URL
              target="_blank"
              rel="noopener noreferrer"
              className="text-white hover:text-amber-300 transition-colors duration-300"
              aria-label="TikTok"
            >
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.88-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.63.41-1.11 1.04-1.36 1.75-.21.51-.25 1.06-.15 1.58.05.34.15.67.29.98.49 1.08 1.59 1.94 2.78 2.03.92.04 1.85-.32 2.49-.96.59-.59.93-1.4 1-2.24.07-1.57.03-3.14.03-4.71 0-3.99-.01-7.98 0-11.97z"/>
              </svg>
            </a>
          </div>
        </div>
      ...
      {/* Right section: Developer info and social links */}
      <div className="text-center">
        ...
        <div className="flex justify-center space-x-4">
          ...
          {/* Telegram */}
          <a
            href="https://t.me/kerekassakia"  // Removed @ for correct URL format
            target="_blank"
            rel="noopener noreferrer"
            className="text-white hover:text-amber-300 transition-colors duration-300"
            aria-label="Telegram"
